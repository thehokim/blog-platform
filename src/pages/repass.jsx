...
function Repass() {
  ...
  return (
    <div>
      <section class='bg-gray-50 dark:bg-gradient-to-br from-gray-200 via-gray-500 to-gray-700'>
            ...
            <div class='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              <form class='space-y-4 md:space-y-6' action='#'>
                ...
                <button
                  ...
                  class='w-full mt-10 cursor-pointer bg-blue-700 text-white px-5 py-2 rounded-lg shadow-md font-semibold transition-all duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-lg'
                >
