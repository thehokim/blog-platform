...
const SubmitButton = ({ onSubmit }) => {
  ...
  return (
    <div className="flex justify-end mt-6">
      <button
        onClick={onSubmit}
        className="flex items-center gap-2 px-6 py-3 bg-blue-700 text-white font-medium rounded-lg hover:bg-blue-800 transition-all duration-300 transform hover:scale-105"
      >
        {t("Далее")}
