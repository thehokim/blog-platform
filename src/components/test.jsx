  ...
  const links = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 333334 333334" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" width="20" height="20" className="mr-2">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 512" width="20" height="20" className="mr-2">
    ...
    },
    {
      ...
      },
      {
        ...
        icon: (
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 119.45 122.88" width="20" height="20" className="mr-2">
      ...
      },
      {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 509 507.14" width="20" height="20" className="mr-2">
    ...
    >
      ...
      <button className="flex items-center justify-center">
        <svg
          ...
          stroke="black"
          strokeWidth="1.5"
          className="w-6 h-6 transition-all duration-300 ease-in-out hover:fill-black transform hover:-translate-y-0.5 z-50"
        >
      ...
      {/* Speed Dial Options */}
      <div
        className={`absolute flex top-0 left-full items-center space-x-4 transition-all duration-300 ${
      ...
      >
        {links.map((link, index) => (
          <a
            ...
            style={{
              transition: `opacity 300ms ease ${index * 100}ms, transform 300ms ease ${index * 100}ms`,
        ...
        <button
          ...
          style={{
            transition: `opacity 300ms ease ${links.length * 100}ms, transform 300ms ease ${
              links.length * 100
            }ms`,
            transform: isOpen ? "translateX(0)" : "translateX(-20px)",
            opacity: isOpen ? 1 : 0,
