...
function Navbar() {
  ...
  // useEffect(() => {
  //   // Запрос к API для получения количества уведомлений
  //   fetch('http://localhost:8080/api/notifications')
  //     .then((response) => response.json())
  //     .then((data) => {
  //       setNewNotifications(data.count); // Установить количество уведомлений из API
  //     });
  // }, []);

  const handleNotificationsClick = () => {
    // Отправить запрос на бэкенд, чтобы отметить уведомления как прочитанные
