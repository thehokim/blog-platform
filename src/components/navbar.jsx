...
function Navbar() {
  ...
  // Состояние для количества новых (непрочитанных) уведомлений
  ...
  // Функция для опроса API, возвращающего количество непрочитанных уведомлений
  const fetchNewNotificationsCount = async () => {
    const userId = localStorage.getItem("userId");
    if (!userId) return;
    try {
      // Предположим, что API имеет endpoint, возвращающий { count: number }
  ...
  // Опрашиваем сервер каждые 30 секунд
  useEffect(() => {
  ...
  // При клике на уведомления сбрасываем их количество (считаем прочитанными)
    ...
    <nav className={"bg-white border-gray-200 dark:bg-gray-900"}>
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          } absolute top-20 right-0 w-23% bg-white rounded-xl text-left px-8 dark:bg-gray-900 z-10 grid-cols-1 gap-y-2 p-4 md:relative md:block md:top-auto md:left-auto md:w-auto md:grid-cols-none md:gap-y-0 md:p-0`}
          onMouseLeave={() => setIsMenuOpen(false)} // Закрывает меню при уходе курсора
        >
          <ul className="grid grid-cols-1 gap-y-2 md:flex md:flex-row md:space-x-6 md:gap-y-0 text-gray-900 dark:text-white">
        ...
        {/* Right Section: Create Blog and Login buttons */}
        <div className="flex items-center space-x-4 ml-5">
          ...
          <Link
            to="/beditor"
            className="w-10 h-10 flex items-center justify-center bg-blue-700 dark:bg-blue-700 hover:bg-blue-800 rounded-full cursor-pointer transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 hover:shadow-lg`"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <div className="relative">
            <Link
              to="/notifpage"
              className="w-10 h-10 flex items-center justify-center bg-blue-700 dark:bg-blue-700 hover:bg-blue-800 rounded-full cursor-pointer transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 hover:shadow-lg"
              // onClick={handleNotificationsClick} // Устанавливаем обработчик
            >
              <BellIcon className="w-5 h-5 fill-white stroke-white" />
            </Link>
            {/* Показать индикатор только если есть новые уведомления */}
            {newNotifications > 0 && (
          ...
          {TOKEN ? (
            <button
              ...
              type="button"
              className="flex items-center px-2.5 py-2.5 bg-blue-700 dark:bg-blue-700 hover:bg-blue-800 text-white rounded-full transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 hover:shadow-lg"
            >
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="flex items-center justify-center w-10 h-10 text-white bg-blue-700 rounded-full shadow-lg hover:bg-blue-800 dark:bg-blue-700 dark:hover:bg-blue-700 transition-all duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-lg z-10"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
